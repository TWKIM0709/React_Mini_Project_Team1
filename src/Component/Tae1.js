    ...
    return(
        <div id="tae1">
                    <Card style={{ width: '18rem' }}>
                            ...
                            <Card.Body>
                                <Card.Title><p>스파이더맨 : 노 웨이 홈</p></Card.Title>
                                <Card.Text>
                                <p style={{fontSize:'15px'}}>2021년 12월 15일 개봉한 마블 시네마틱 유니버스의 27번째 장편 영화이자 페이즈 4의 네번째 영화.
                                그리고 마블 스튜디오 스파이더맨 시리즈의 3번째 작품이며 홈커밍 트릴로지의 마지막 작품이다.</p>
                                </Card.Text>
